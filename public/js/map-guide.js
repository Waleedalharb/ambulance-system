...
(function () {
    ...
    var INFO = {
        ...
        'kpi-alerts': {
            t: 'حالات حرجة',
            h: '<p><b>ما هو؟</b> عدد الحالات التي تجاوزت الآن الحد الزمني المعتمد وتحتاج تدخلًا.</p>'
                + '<p><b>الحدود المعتمدة:</b> وصول 10 دقائق · مباشرة 12 دقيقة · بقاء في الموقع 15 دقيقة.</p>'
                + '<p><b>مصدره:</b> أحداث CAD الفعلية فقط — <b>لا تنبيه لفرقة لم تتحرك</b>، والبلاغ المنتهي تنتهي تنبيهاته معه.</p>'
        },
        'hist-memory': {
            t: 'ذاكرة الخريطة',
