...
const PERMISSIONS = {
    ...
    // بوابة الموظف التشغيلية v1 (معتمدة 2026-09-04): منح فردي لمن لهم ملف employee مطابق — لا دور يحملها
    'ops.my_portal':        { label: 'بوابة الموظف التشغيلية (منح فردي فقط — لا دور يحملها)', domain: 'ops' },
    // تقييد دليل الجوالات (معتمد 2026-09-04): رؤية phone في مسارات /api/employees — منفصلة عن بيانات
    // توثيق الجوال (phone_verified*) التي تبقى لحامل admin.users_manage فقط. منح فردي حصرًا: لا دور يحملها.
    // domain ops حتى تظهر في لوحة الصلاحيات القائمة دون تعديل واجهات (قيد المالك).
    'staff.phone_view':     { label: 'الاطلاع على دليل جوالات الموظفين (منح فردي فقط — لا دور يحملها)', domain: 'ops' },
    // الموقع التشغيلي الحي للفرق (TL1 معتمد 2026-09-21): قراءة مواقع الفرق — بيانات
    // أشد حساسية من الجوالات، فتُنسخ سابقة staff.phone_view: منح فردي حصرًا ولا دور
    // يحملها. الإرسال لا يحتاج مفتاحًا جديدًا — محروس بـ ops.my_portal + حسم سيرفري
    // للفرقة الميدانية من تكليف اليوم.
    'ops.team_locations.view': { label: 'الاطلاع على المواقع الحية للفرق (منح فردي فقط — لا دور يحملها)', domain: 'ops' },
