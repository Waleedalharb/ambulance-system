    ...
    HELMET_CONFIG: {
        contentSecurityPolicy: {
            directives: {
                ...
                imgSrc: ["'self'", "data:", "blob:", "https://unpkg.com", "https://*.tile.openstreetmap.org", "https://tile.openstreetmap.org", "https://*.basemaps.cartocdn.com", "https://api.mapbox.com", "https://*.tiles.mapbox.com"],
                connectSrc: ["'self'", "wss:", "ws:", "https://cdn.jsdelivr.net", "https://unpkg.com", "https://cdnjs.cloudflare.com", "https://*.basemaps.cartocdn.com", "https://tile.openstreetmap.org", "https://*.tile.openstreetmap.org", "https://api.mapbox.com", "https://*.tiles.mapbox.com", "https://events.mapbox.com"],
                workerSrc: ["'self'", "blob:"], // عمال Mapbox GL (رسم الخريطة فقط)
                childSrc: ["'self'", "blob:"],
                mediaSrc: ["'self'"],
                frameSrc: ["'self'"],
            },
